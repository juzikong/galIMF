    ...
    if epoch_index == epoch_info_length:  # if not:
        ...
        if S_F_R_of_this_epoch > 0:
            ...
            if imf == 'igimf':
                ...
                file = open('Simulation_results_from_galaxy_evol/IGIMFsimf{}STF{}logSFR{}SFEN{}.txt'.format(imf, round(STF*100), round(maximum_SFR*100), SFEN), 'r')
                old_lines = file.read()
                file.close()
                file = open('Simulation_results_from_galaxy_evol/IGIMFsimf{}STF{}logSFR{}SFEN{}.txt'.format(imf, round(STF*100), round(maximum_SFR*100), SFEN), 'w')
            ...
            file_r = open('Simulation_results_from_galaxy_evol/IGIMFsimf{}STF{}logSFR{}SFEN{}.txt'.format(imf, round(STF*100), round(maximum_SFR*100), SFEN), 'r')
            ...
            file_w = open('Simulation_results_from_galaxy_evol/IGIMFsimf{}STF{}logSFR{}SFEN{}.txt'.format(imf, round(STF*100), round(maximum_SFR*100), SFEN), 'w')
...
def galaxy_evol(imf='igimf', STF=0.5, SFEN=100, Z_0=0.000000134, solar_mass_component='Anders1989_mass',
    ...
    file = open(
        'Simulation_results_from_galaxy_evol/IGIMFsimf{}STF{}logSFR{}SFEN{}.txt'.format(imf, round(STF*100), round(maximum_SFR*100), SFEN), 'w')
...
def function_get_target_mass_in_range(gwimf, STF, maximum_SFR, SFEN, log_Z_0, epoch_index, lower_mass_limit, upper_mass_limit, mass_grid_table_number, Mtarget_table_number,
                                      mass_calibration_factor, mass_grid_table, mass_grid_table2, Mfinal_table, Mmetal_table, M_element_table):
    if gwimf == 'igimf':
        file = open('Simulation_results_from_galaxy_evol/IGIMFsimf{}STF{}logSFR{}SFEN{}.txt'.format(gwimf, round(STF*100), round(maximum_SFR*100), SFEN), 'r')
