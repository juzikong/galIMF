...
def plot_galaxy_evol():
    ...
    plt.rc('xtick', labelsize='x-small')
    plt.rc('ytick', labelsize='x-small')
    fig = plt.figure(6, figsize=(3.5, 3))
    fig.add_subplot(1, 1, 1)
...
def plot_galaxy_evol_extended():
    ...
    plt.rc('xtick', labelsize='x-small')
    plt.rc('ytick', labelsize='x-small')
    fig = plt.figure(101, figsize=(3.5, 2.8))
    fig.add_subplot(1, 1, 1)
    i = time_length-1
    plot_limit=19
    xs = []
    ...
    plt.rc('xtick', labelsize='x-small')
    plt.rc('ytick', labelsize='x-small')
    fig = plt.figure(106, figsize=(3, 3))
    fig.add_subplot(1, 1, 1)
    plt.plot([], [], ls='dotted', lw=0.7, label='Star, luminosity-weighted', color="b")
    plt.plot([], [], label='Gas, mass-weighted', lw=0.7, color="tab:red")
    plt.plot([], [], ls='dashed', lw=0.7, label='Star, mass-weighted', color="k")
    # plt.plot([], [], label='boxy SFH', lw=3, color="tab:orange")
    # plt.plot([], [], label='log-norm SFH', lw=3, color="tab:red")
    # plt.plot(log_time_axis, gas_Fe_over_H_list, color='tab:orange', lw=0.7)
    # plt.plot(log_time_axis, stellar_Fe_over_H_list, color='tab:orange', lw=0.7, ls='dashed')
    # plt.plot(log_time_axis, stellar_Fe_over_H_list_luminosity_weighted, ls='dotted', lw=0.7, color="tab:orange")
    plt.plot(log_time_axis_extended, stellar_Fe_over_H_list_luminosity_weighted_extended, ls='dotted', lw=0.7, color="b")
    plt.plot(log_time_axis_extended, gas_Fe_over_H_list_extended, color='tab:red', lw=0.7)
    plt.plot(log_time_axis_extended, stellar_Fe_over_H_list_extended, color='k', lw=0.7, ls='dashed')
    # plt.plot([7, 10.114], [0, 0], color='red', ls='dotted', label='solar')
    plt.xlabel(r'log$_{10}$(time [yr])')
    plt.ylabel('[Fe/H]')
    plt.xlim(7, 10.114)
    ...
    del gas_Fe_over_H_list[0]
    del gas_Mg_over_Fe_list[0]
    ...
    del gas_Fe_over_H_list_extended[0]
    del gas_Mg_over_Fe_list_extended[0]
    del stellar_Fe_over_H_list_extended[0]
    del stellar_Mg_over_Fe_list_extended[0]
    del stellar_Fe_over_H_list_luminosity_weighted_extended[0]
    del stellar_Mg_over_Fe_list_luminosity_weighted_extended[0]

    plt.rc('font', family='serif')
    plt.rc('xtick', labelsize='x-small')
    plt.rc('ytick', labelsize='x-small')
    fig = plt.figure(110, figsize=(4, 4.8))
    fig.add_subplot(1, 1, 1)
    plt.plot([], [], label='Gas', lw=0.7, color="k")
    plt.plot([], [], ls='dashed', lw=0.7, label='Stellar mass-weighted', color="k")
    plt.plot([], [], ls='dotted', lw=0.7, label='Stellar luminosity-weighted', color="k")
    plt.plot([], [], label='boxy SFH', lw=3, color="tab:orange")
    plt.plot([], [], label='log-norm SFH', lw=3, color="tab:red")
    plt.plot(gas_Fe_over_H_list, gas_Mg_over_Fe_list, color='tab:orange', lw=0.7)
    plt.plot(stellar_Fe_over_H_list, stellar_Mg_over_Fe_list, color='tab:orange', lw=0.7, ls='dashed')
    plt.plot(stellar_Fe_over_H_list_luminosity_weighted, stellar_Mg_over_Fe_list_luminosity_weighted, ls='dotted', lw=0.7, color="tab:orange")
    plt.plot(gas_Fe_over_H_list_extended, gas_Mg_over_Fe_list_extended, color='tab:red', lw=0.7)
    plt.plot(stellar_Fe_over_H_list_extended, stellar_Mg_over_Fe_list_extended, color='tab:red', lw=0.7, ls='dashed')
    plt.plot(stellar_Fe_over_H_list_luminosity_weighted_extended, stellar_Mg_over_Fe_list_luminosity_weighted_extended, ls='dotted', lw=0.7, color="tab:red")
    # plt.plot([7, 10.114], [0, 0], color='red', ls='dotted', label='solar')
    plt.xlabel('[Fe/H]')
    plt.ylabel('[Mg/Fe]')
    # plt.xlim(7, 10.114)
    ...
    plt.legend(prop={'size': 7}, loc='best')
    plt.tight_layout()
    plt.savefig('simulation_results_from_galaxy_evol/Mg_over_Fe_Fe_over_H_time_extended.pdf', dpi=250)

    return

if __name__ == '__main__':
    # plots for two different set of simulations, i.e., boxy SFH and lognormal SFH:
    # plot_galaxy_evol()  # compare different IMF
    plot_galaxy_evol_extended()  # compare different SFH
    plt.show()
